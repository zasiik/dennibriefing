...
def vyber_a_preloz(zpravy):
    ...
    if ft_epizoda:
        blok_ft = (
            ...
            "Briefing (Financial Times). Vytvoř objekt "
            "{\"shrnuti\": 2–4 věty přirozenou češtinou o čem dnešní epizoda "
            "je, \"shrnuti_en\": totéž anglicky}. Piš jen to, co je v popisu.\n"
...
{seznam}"""
    ...
    try:
        ...
        if ft_epizoda and isinstance(surove_ft, dict) and surove_ft.get("shrnuti"):
            ft_briefing = {
                "titulek": ft_epizoda["titulek"],
                "odkaz": ft_epizoda["odkaz"],
                "shrnuti": surove_ft["shrnuti"],
                "shrnuti_en": surove_ft.get("shrnuti_en", surove_ft["shrnuti"]),
            }
        sledovat = [
